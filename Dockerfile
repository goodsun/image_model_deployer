...
RUN mkdir -p /ComfyUI/models/checkpoints && \
    wget -q https://huggingface.co/cagliostrolab/animagine-xl-4.0/resolve/main/animagine-xl-4.0.safetensors \
    -O /ComfyUI/models/checkpoints/animagine-xl-4.0.safetensors
